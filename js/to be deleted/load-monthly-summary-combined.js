  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      summary.forEach((entry) => {
        ...
        row.insertCell(13).textContent = secondsToHHMM(theoreticalPaidSeconds);
        ...
        row.insertCell(15).textContent = secondsToHHMM(actualPaidSeconds);

        // === REMARKS ===
        row.insertCell(16).textContent = entry.remarks || "--";
      });
      ...
      totalRow.insertCell(13).textContent = secondsToHHMM(
        mtdTheoreticalPaidSeconds,
      );

      totalRow.insertCell(14).textContent = "--";
      ...
      totalRow.insertCell(15).textContent = secondsToHHMM(mtdActualPaidSeconds);
      totalRow.insertCell(16).textContent = "--";
